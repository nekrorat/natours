(() => {
  ...
  var require_redefine = __commonJS({
    "node_modules/core-js/modules/_redefine.js"(exports, module) {
      ...
      (module.exports = function(O, key, val, safe) {
        ...
        if (isFunction3) has(val, "name") || hide(val, "name", key);
        if (O[key] === val) return;
        if (isFunction3) has(val, SRC) || hide(val, SRC, O[key] ? "" + O[key] : TPL.join(String(key)));
        if (O === global2) {
          O[key] = val;
        } else if (!safe) {
          delete O[key];
  ...
  var require_es7_promise_finally = __commonJS({
    "node_modules/core-js/modules/es7.promise.finally.js"() {
      ...
      $export($export.P + $export.R, "Promise", { "finally": function(onFinally) {
        ...
        var isFunction3 = typeof onFinally == "function";
        return this.then(
  ...
  var displayMap = (locations) => {
    mapboxgl.accessToken = "pk.eyJ1IjoibmVrcm9yYXQiLCJhIjoiY21oZ3djbzBqMGtrbDJsbjhvd3Q5djBnbCJ9.w5kZNbgbS1h6bP8fM57JIQ";
    const map = new mapboxgl.Map({
      container: "map",
      // container ID
      style: "mapbox://styles/nekrorat/cmhgwyuoa00i101qwdd2kdcs5",
      // style URL
      scrollZoom: false
